...
function App() {
  ...
  useEffect(() => {
    // ✅ Vite frontend env must use import.meta.env
    // Support both names just in case you renamed the env var
    const k1 = import.meta.env.VITE_API_KEY as string | undefined;
  ...
  return (
    <div
      className="min-h-screen pb-20 bg-slate-50 selection:bg-indigo-100 text-slate-900"
      lang="en"
    >
      {/* ✅ Guide / Help overlay */}
      <HelpPanel
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 h-full flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-xl font-black tracking-tight leading-none">
                AuraOps <span className="text-indigo-400 italic">Intelligence</span>
              </h1>
          ...
          <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-2">
                <span
                  className={`w-1.5 h-1.5 rounded-full ${
                    isApiConfigured ? "bg-emerald-500 animate-pulse" : "bg-rose-500"
                  }`}
                />
            ...
            <button
              ...
              className="bg-indigo-600 hover:bg-indigo-700 px-5 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all border border-indigo-500 shadow-lg shadow-indigo-500/20 flex items-center gap-2"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-3 w-3"
            ...
            <button
              ...
              className="hidden sm:block bg-white/5 hover:bg-white/10 px-5 py-2.5 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all border border-white/10"
            >
              Export Report
            </button>
          </div>
          ...
          <div className="lg:col-span-3 space-y-6">
            <div className="bg-white p-6 rounded-[2rem] shadow-sm border border-slate-200">
              ...
              <input
                ...
                className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm font-bold text-indigo-600 outline-none mb-4"
              />
              <input
                type="text"
                value={location}
          ...
          <div className="lg:col-span-8 bg-white rounded-[2rem] border border-slate-200 overflow-hidden">
            <table className="min-w-full divide-y divide-slate-100">
              <thead className="bg-slate-50">
                <tr>
                  <th className="px-6 py-4 text-left text-[10px] font-black text-slate-400 uppercase">
                    Date
                  </th>
                  <th className="px-6 py-4 text-left text-[10px] font-black text-slate-400 uppercase">
                    Staff
